...
public class TaskController {
    ...
    @GetMapping
    public ResponseEntity<Page<TaskResponse>> getAllTasks(@RequestParam(required = false) String search, @RequestParam(required = false) TaskStatus status, @RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "10") int size, @RequestParam(defaultValue = "updatedTime,desc") String sort) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<TaskResponse> updateTaskDetails(@PathVariable Long id,
